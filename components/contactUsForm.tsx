      ...
      <div className='lg:col-span-5 space-y-6 text-right'>
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          >
            ...
            <div>
              <h4 className="text-zinc-400 text-xs font-semibold mb-0.5">الايميل الخاص بالشركه</h4>
              <a href="mailto:Property66@gmail.com" className="text-zinc-900 font-bold text-base hover:text-amber-500 transition-colors block font-sans">
          ...
          >
            ...
            <div>
              <h4 className="text-zinc-400 text-xs font-semibold mb-0.5">رقم الهاتف</h4>
              <a href="tel:0102514489" className="text-zinc-900 font-bold text-base hover:text-amber-500 transition-colors block tracking-wide">
                0102514489
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <h4 className="text-zinc-400 text-xs font-semibold mb-0.5">العنوان</h4>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  <FormLabel className="text-sm font-bold text-zinc-800">الاسم بالكامل</FormLabel>
                  <FormControl>
                    <Input placeholder="أحمد محمد" className="border-t-0 border-x-0 border-b-2 border-zinc-200 rounded-none bg-transparent px-0 pb-3 pt-1 focus-visible:ring-0 focus-visible:border-amber-500 transition-colors duration-300 placeholder:text-zinc-300 text-base text-right shadow-none font-medium" dir="rtl" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
